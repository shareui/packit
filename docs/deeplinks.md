...
```
tg://packit?plugin=<plugin_id>&repo=<rm_rid>
```
...
Загружает плагин из репозитория и открывает его страницу профиля.
...
Fetches the plugin from the repository and opens its profile page.
